---
title: "Modélisation et Outils Mathématiques, TP génération de nombres aléatoires et probabilités"
...
résultats s'approchent de ceux obtenus avec la formule de Little
($E(N) = \lambda * E(W)$).
